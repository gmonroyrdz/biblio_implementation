...
INSERT INTO categoria(nombre) VALUES ('Ciencias', 'Humanidades', 'Ingeniería');

INSERT INTO libro(titulo, anio_publicacion,isbn) VALUES('Cien años de soledad',1967, '1234567890'), ('Principia Mathematica', 1687, '0987654321');
...
INSERT INTO usuario(nombre, correo, matricula, tipo) VALUES 
    ('Juan Pérez','juan@cua.uam.mx','12344','estudiante'),
    ('Ana López', 'ana@cua.uam.mx', '44321', 'profesor');
